...
public class ImageAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        //TextView picUrl=(TextView)itemView.findViewById(R.id.urlTxt);
       // TextView userName=(TextView)itemView.findViewById(R.id.userTxt);
      //  ImageView imageViews = (ImageView) itemView.findViewById(R.id.imageView4);
        ImageView imageView = (ImageView) itemView.findViewById(R.id.imageView5);
        Image selectedImg=img.get(position);
        //userName.setText(selectedImg.getUser());
